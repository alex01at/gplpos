...
public final class PlacesEditor extends JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("<html>Mit einen Koordinatensystem können sie ihre Tische platzieren.<br /> Es wird der Mittelpunkt eines Rechtecks genommen.<br>Startpunkt ist oben links (0,0).<br /> Es wird alles in Pixel eingegeben.");
