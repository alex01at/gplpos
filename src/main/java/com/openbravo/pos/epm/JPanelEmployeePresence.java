...
public class JPanelEmployeePresence extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    ...
    public void activate() throws BasicException {
        ...
        if (isOnLeave) {
            ...
            if (isOnBreak) {
                Object[] LastBreak = dlpresencemanagement.GetLastBreak(app.getAppUserView().getUser().getId());
                message.setText(app.getAppUserView().getUser().getName()+" "+AppLocal.getIntString("message.leavefor")+" "+LastBreak[0] +" "+AppLocal.getIntString("message.at")+" "+ Formats.TIMESTAMP.formatValue(LastBreak[1]));
                BreakAction();
            }
        }
    }
